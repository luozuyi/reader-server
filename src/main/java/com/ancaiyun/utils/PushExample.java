...
public class PushExample {
    ...
    protected static final String APP_KEY ="0a1ed5bc77d5ed32f7aa5393";
    protected static final String MASTER_SECRET = "69ce72dbc1f2adf3f81d28c0";
    ...
    public static final String REGISTRATION_ID = "160a3797c82f0e695b7";
    public static final String TAG = "1d67d85174d2437b9a1c8c562cdc1267";
...
//        testSendPushWithCallback();
        sendPushAfterFollow(TAG,"haha");
//        sendPushAfterFollowRegist(REGISTRATION_ID,"haha");
    }
...
//        ApacheHttpClient httpClient = new ApacheHttpClient(authCode, null, clientConfig);
    ...
    public static void sendPushAfterFollow(String alias ,String nickname) {
        try {
            ...
            payload.resetOptionsTimeToLive(10);
            PushResult result = jpushClient.sendPush(payload);
            LOG.info("Got result - " + result);
        } catch (APIConnectionException e) {
    ...
    public static void sendPushAfterFollowRegist(String registrationId ,String nickname) {
        try {
            JPushClient jpushClient = new JPushClient(MASTER_SECRET, APP_KEY, null, ClientConfig.getInstance());
            //生成推送的内容
            PushPayload payload = buildPushObject_regist_followUser(registrationId, nickname);
            payload.resetOptionsTimeToLive(10);
            PushResult result = jpushClient.sendPush(payload);
            LOG.info("Got result - " + result);
        } catch (APIConnectionException e) {
    ...
    public static PushPayload send(String alias ,String nickname) {
        /*1.设置推送平台
    ...
    public static PushPayload buildPushObject_regist_followUser(String registrationId ,String nickname) {
        return PushPayload.newBuilder().setPlatform(Platform.android_ios())
